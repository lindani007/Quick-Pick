...
namespace QuickPick.QuickPickEmployer.ViewModel
{
    public partial class SalesAnalysisViewModel : ObservableObject
    {
        ...
        {
            string fullPath = Path.Combine(FileSystem.AppDataDirectory, Tfile);
            ...
            List<Transaction> transactions = JsonSerializer.Deserialize<List<Transaction>>(json) ?? new List<Transaction>();
